...
*
*/
public class RSGreedyQPolicy extends Policy implements PlannerDerivedPolicy{
protected QComputablePlanner	qplanner;
protected Random rand;
public RSGreedyQPolicy(){
qplanner = null;
...
*/
public RSGreedyQPolicy(QComputablePlanner planner){
qplanner = planner;
rand = RandomFactory.getMapped(0);
}
@Override
...
System.out.println("Using qvalue: " + maxActions.get(selected).q);
